# -*- coding: utf-8 -*-
"""CRWK_CN6009_2026_template_filled.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18HpgKKw9sIzl0sOPwZZNtvIdsi-M2oiU
...
if df_filtered.empty:
    ...
    good_credit_pct = round((df_filtered["class"] == "good").mean() * 100, 2)
    ...
    with colC:
        ...
        df_filtered.boxplot(column="age", by="class", ax=ax3)
...
housing_summary = df_filtered.groupby("housing")["credit_amount"].mean().reset_index()
